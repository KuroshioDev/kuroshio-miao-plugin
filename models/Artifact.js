...
const { artiMap } = require('../resources/meta/artifact/index.js')
const  {attrMap, mainIdMap, attrIdMap} = require('../resources/meta/artifact/index.js').meta
const lodash = require('lodash')
const srMeta = require('../resources/meta-sr/artifact/index.js')
const idMapSR = srMeta.idMap
const artiMapSR = srMeta.artiMap
const metaDataSR = srMeta.metaData
const abbrSR = srMeta.meta.abbr
