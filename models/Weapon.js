...
const { weaponData, weaponAbbr, weaponAlias, weaponType, weaponSet, weaponBuffs } = require( '../resources/meta/weapon/index.js')
const lodash = require( 'lodash')
const weaponDataSR = require('../resources/meta-sr/weapon/index').weaponData
const weaponAliasSR = require('../resources/meta-sr/weapon/index').weaponAlias
const weaponBuffsSR = require('../resources/meta-sr/weapon/index').weaponBuffs
